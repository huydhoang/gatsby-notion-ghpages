      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body">
          ...
          <figure className="kg-card kg-image-card kg-width-full">
            <GatsbyImage
              image={data.fullwidthPic.childImageSharp.gatsbyImageData}
              className="kg-image"
            />
...
const indexQuery = graphql`
  {
    ...
    smallPic: file(
      ...
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 640, height: 480)
      }
    }
    largePic: file(
      relativePath: { eq: "fabio-comparelli-696506-unsplash.jpg" }
      ...
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 1366, height: 1024)
      }
    }
    fullwidthPic: file(
      relativePath: { eq: "fabio-comparelli-696506-unsplash.jpg" }
